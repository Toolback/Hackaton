...
//     // Amount of locked tokens waiting for withdraw (in DeepFy).
...
//         uint256 unlockAmount; // Amount of tokens which is available to withdraw (in DeepFy)
...
//     IERC20Upgradeable public constant deepFyToken =
...
//     IERC20Upgradeable public constant deepFyBalancerLp =
...
//         // deepFyToken.approve(address(exchange), type(uint256).max);
//         // deepFyBalancerLp.approve(address(balancer), type(uint256).max);
...
//     /**
//      * @dev Locks specified amount DeepFy tokens in the contract
//      * @param _amount An amount of DeepFy tokens to lock
//      */
//     function lock(uint256 _amount) public {

//         Locker storage locker = _lockers[msg.sender];

//         deepFyToken.safeTransferFrom(
//             msg.sender,
//             address(this),
//             _amount
//         );
...
//         emit TokensLocked(msg.sender, address(deepFyToken), _amount, lpAmount, block.timestamp );
...
//         uint256 deepFyAmount = _exitDeepFyPoolExactLp(_amount);
...
//         waitingForWithdrawal += deepFyAmount;

//         locker.unlockAmount += deepFyAmount;
//         locker.withdrawUnlockTime = block.timestamp + withdrawLockDuration;

//         emit TokensUnlocked(msg.sender, deepFyAmount, _amount, block.timestamp);
...
//         uint256 deepFyAmount = _exitDeepFyPoolExactLp(amount);
...
//         emit TokensUnlocked(msg.sender, deepFyAmount, amount, block.timestamp);
...
//         deepFyToken.safeTransfer(msg.sender, amount);
...
//         deepFyToken.safeTransfer(msg.sender, reward);
...
//     /**
//      * @dev converts amount of DeepFy to Lp based on current ratio
//      * @param _amount amount of DeepFy tokens
//      * @return amount amount of Lp tokens
//      */
//     function convertDeepFyToLp(uint256 _amount)
//         external
//         view
//         returns (uint256)
//     {
//         uint256 deepFyOnBalancer = deepFyToken.balanceOf(address(balancer));
//         uint256 totalBalancerDeepFyLp = ERC20Upgradeable(address(deepFyBalancerLp)).totalSupply();
//         uint256 deepFyPerLp = deepFyOnBalancer * 100 * 100000000 / totalBalancerDeepFyLp / 80;
//         return 
//         _amount * 100000000 / deepFyPerLp;
//     }

//     /**
//      * @dev converts amount of Lp to DeepFy tokens based on current ratio
//      * @param _amount amount of Lp tokens
//      * @return amount amount of DeepFy tokens
//      */
//     function convertLpToDeepFy(uint256 _amount)
//         external
//         view
//         returns (uint256)
//     {
...
//      * @return unlockAmount_ Unlocked amount of tokens (in DeepFy)
...
//     function _exitDeepFyPoolExactLp(uint256 lpAmount) private returns (uint256) {
...
//             false
//         );
//         uint256 deepFyBalanceBefore = deepFyToken.balanceOf(address(this));
//         balancer.exitPool(
//             poolId,
//             address(this),
...
//         return deepFyToken.balanceOf(address(this)) - deepFyBalanceBefore;
//     }
