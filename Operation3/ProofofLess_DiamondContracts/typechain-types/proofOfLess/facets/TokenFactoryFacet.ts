...
export interface TokenFactoryFacetInterface extends utils.Interface {
  functions: {
...
export interface TokenFactoryFacet extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TokenFactoryFacetInterface;
